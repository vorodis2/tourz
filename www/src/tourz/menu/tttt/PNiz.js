...
export class PNiz extends MOBaza {
  	constructor(par,fun) {  
        super(par,fun);
  		this.type="PNiz";
        this.linkIcon = "resources/image/pic1.png";
        this.linkIcon1 = "resources/image/pic1_.png";
        this.text="TAGLINKS";
...
/*
        ...
        this.gallery.boolWheel=true
        this.gallery.dragActiv=true


        this.gallery.visible=this.batton.visible=false;
